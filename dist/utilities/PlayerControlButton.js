...
const playerRowOne = (client, disable) => new ActionRowBuilder().addComponents([
    new ButtonBuilder()
        .setCustomId('stop')
...
const playerRowTwo = (client, disable) => new ActionRowBuilder().addComponents([
    new ButtonBuilder()
        .setCustomId('shuffle')
...
const playerRowOneEdited = (client, disable) => new ActionRowBuilder().addComponents([
    new ButtonBuilder()
        .setCustomId('stop')
        .setEmoji(client.config.emojis.PLAYER.stop)
        .setStyle(ButtonStyle.Secondary)
...
const filterSelect = (client, disable) => new ActionRowBuilder().addComponents(new StringSelectMenuBuilder()
    .setCustomId('filter')
