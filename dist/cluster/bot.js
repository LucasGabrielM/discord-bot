...
export function bootBot(clusterManager) {
    const configData = new ConfigDataService().data;
    const byteblaze = new Manager(configData, configData.utilities.MESSAGE_CONTENT.enable, clusterManager);
    // Anti crash handling
    process
        ...
        .on('exit', () => byteblaze.logger.info('ClientManager', `Successfully Powered Off ByteBlaze, Good Bye!`))
        .on('SIGINT', () => {
