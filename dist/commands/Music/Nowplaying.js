                ...
                const interval = setInterval(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        const channel = (yield client.channels
                            .fetch(`${(_d = handler.channel) === null || _d === void 0 ? void 0 : _d.id}`)
                            .catch(() => undefined));
                        if (!channel)
                            return;
                        const message = yield channel.messages
                            .fetch(`${(_e = currentNPInterval === null || currentNPInterval === void 0 ? void 0 : currentNPInterval.msg) === null || _e === void 0 ? void 0 : _e.id}`)
                            .catch(() => undefined);
                        if (!message)
                            return;
