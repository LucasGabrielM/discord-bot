        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (db.isPremium) {
                ...
                const embed = new EmbedBuilder()
                    .setDescription(`${client.i18n.get(handler.language, 'command.premium', 'remove_desc', {
                ...
                const embed = new EmbedBuilder()
                    .setDescription(`${client.i18n.get(handler.language, 'command.premium', 'remove_already', {
