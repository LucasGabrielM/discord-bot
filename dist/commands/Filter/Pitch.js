...
export default class {
    constructor() {
        this.name = ['pitch'];
        this.description = 'Sets the pitch of the song.';
    ...
    execute(client, handler) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (player === null || player === void 0 ? void 0 : player.filter.setTimescale({ pitch: Number(value) }));
            player === null || player === void 0 ? void 0 : player.data.set('filter-mode', this.name[0]);
            const embed = new EmbedBuilder()
                .setDescription(`${client.i18n.get(handler.language, 'command.filter', 'pitch_on', {
                amount: value,
            })}`)
                .setColor(client.color);
