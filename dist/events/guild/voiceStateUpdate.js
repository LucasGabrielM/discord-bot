...
export default class {
    execute(client, oldState, newState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const isNoOneInChannel = newState.channelId == null && ((_b = newState.member) === null || _b === void 0 ? void 0 : _b.user.id) === ((_c = client.user) === null || _c === void 0 ? void 0 : _c.id);
            const isNotDestroy = !player.data.get('sudo-destroy') && player.state !== RainlinkPlayerState.DESTROYED;
            ...
            const isNotSudo = !player.data.get('sudo-destroy') && player.state !== RainlinkPlayerState.DESTROYED;
            ...
            if (isInOldVoice &&
                ...
                let leaveDelayTimeout = setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                    var _a, _b;
                    const vcMembers = (_a = oldState.guild.members.me.voice.channel) === null || _a === void 0 ? void 0 : _a.members.filter((m) => !m.user.bot).size;
                    if (!vcMembers || vcMembers === 1) {
                        const newPlayer = (_b = client.rainlink) === null || _b === void 0 ? void 0 : _b.players.get(newState.guild.id);
                        player.data.set('sudo-destroy', true);
                        if (newPlayer)
