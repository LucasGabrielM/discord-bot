...
exports.RainlinkPlugin = void 0;
const rainlink_1 = require("rainlink");
const rainlink_2 = require("rainlink");
const rainlink_3 = require("rainlink");
const rainlink_4 = require("rainlink");
const API_URL = 'https://api.deezer.com/';
const REGEX = /^https?:\/\/(?:www\.)?deezer\.com\/[a-z]+\/(track|album|playlist)\/(\d+)$/;
const SHORT_REGEX = /^https:\/\/deezer\.page\.link\/[a-zA-Z0-9]{12}$/;
class RainlinkPlugin extends rainlink_3.SourceRainlinkPlugin {
    /**
     ...
     */
    type() {
        return rainlink_4.RainlinkPluginType.SourceResolver;
    }
    /**
     * Initialize the plugin.
     */
    constructor(options = { market: 'us' }) {
        super();
        this.options = options;
        if (!options.market)
            this.options.market = 'us';
        this.methods = {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (type in this.methods) {
                ...
                try {
                    ...
                    const loadType = type === 'track' ? rainlink_1.RainlinkSearchResultType.TRACK : rainlink_1.RainlinkSearchResultType.PLAYLIST;
                    ...
                    return this.buildSearch(undefined, [], rainlink_1.RainlinkSearchResultType.SEARCH);
                }
            }
                ...
                return this.buildSearch(undefined, result.tracks, rainlink_1.RainlinkSearchResultType.SEARCH);
            }
            else
                return this.buildSearch(undefined, [], rainlink_1.RainlinkSearchResultType.SEARCH);
        });
    ...
    buildSearch(playlistName, tracks = [], type) {
        return {
            playlistName,
            tracks,
            type: type !== null && type !== void 0 ? type : rainlink_1.RainlinkSearchResultType.SEARCH,
        };
    }
    buildRainlinkTrack(dezzerTrack, requester) {
        return new rainlink_2.RainlinkTrack({
            encoded: '',
            info: {
    ...
    debug(logs) {
        this.manager ? this.manager.emit(rainlink_4.RainlinkEvents.Debug, `[Rainlink Deezer Plugin]: ${logs}`) : true;
    }
}
exports.RainlinkPlugin = RainlinkPlugin;
